...
We reverse default port of power bi report server from 8789 into 7000 and use basic authentication header using base64 encryption with format base64('username:password')
